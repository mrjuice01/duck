...
'
echo " " 
echo -e "$red #$pink Mr Juice$grn $red#$rset"
echo 
# Functions
...
then
am start -a android.intent.action.VIEW -d http://mrjuicetermuxcomands1.blogspot.com/2022/10/mr-juice-apps-modz.html > /dev/null 2>&1
banner
menu
elif [ $optnz = "5" ];
then
...
echo -e '\e[91m
  ...
  ||    ||
'
echo -e "\e[93m                  CALL ME \e[92mMR.JUICE" | pv -qL 10
echo -e "\e[93m             ADMIN OF \e[92mERROR MODS TEAM" | pv -qL 10
echo -e "\e[93m             HOPE YOU LIKE THIS SCRIPT" | pv -qL 10
echo -e "\e[93m         Keep Supporting And Join Us " | pv -qL 10
echo -e "\e[93m         Join Us:\e[92m http://mrjuicetermuxcomands1.blogspot.com/2022/10/mr-juice-apps-modz.html\e[0m" | pv -qL 10
...
while git clone https://github.com/mrjuice01/duck 2> /dev/null; do 
    printf  "\e[92m▓▓▓▓▓▓▓▓▓▓▓▓▓\e[0m"
    sleep 1
done
printf "\e[96m]\e[0m"
